...
ALTER TABLE RESTAURANT ADD FOREIGN KEY (CodeDepartement) REFERENCES DEPARTEMENT(CodeDepartement);
ALTER TABLE RESTAURANT ADD FOREIGN KEY (CodeRegion) REFERENCES REGION(CodeRegion);
